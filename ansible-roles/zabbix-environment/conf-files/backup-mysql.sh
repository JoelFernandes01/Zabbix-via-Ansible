...
sleep 5
$mysqldump -u$mysql_root_user -p$mysql_root_pass $mysql_zbx_mdb > $mysql_zbx_mdb.$today.sql
echo =======================================================================================
...
sleep 5
echo =======================================================================================
echo 	    "Copiando o arquivo "$mysql_zbx_mdb.$today.sql" para o servidor remoto !" 
echo =======================================================================================
sleep 5
scp $mysql_zbx_mdb.$today.sql $bkp_root_user@$bkp_srv_addr:$bkp_srv_rem

echo =======================================================================================
echo 	    "Copiando o arquivo "$mysql_zbx_mdb.$today.sql" para a pasta $bkp_srv_loc !" 
echo =======================================================================================
sleep 5
